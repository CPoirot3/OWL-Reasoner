...
public class EntailmentChecker implements OWLAxiomVisitorEx<Boolean> {
    ...
    protected class AnonymousIndividualForestBuilder implements OWLAxiomVisitor {
        ...
        /**
         * @param factory The data factory to be used when creating new concepts in the elimination of anonymous individuals.
         * @param axioms  The axioms from the conclusion ontology. After executing this method, the axioms that contain anonymous individuals can be discarded. Instead the methods getAssertions() and getConcepts() can be used to check entailment of the conclusion ontology.
         */
