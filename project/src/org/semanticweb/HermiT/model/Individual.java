...
public class Individual extends Term {
    ...
    /**
     * Returns an Individual with the given identifier. If this function is
     * called multiple times with the same identifier, then the same object will
     * be returned on each call (allowing for fast equality testing). It is the
     * caller's responsibility to normalize the given URI---this function treats
