...
public class DescriptionGraph implements DLPredicate, Serializable {
    ...
    public DescriptionGraph(String name, AtomicConcept[] atomicConceptsByVertices, Edge[] edges,
    ...
    public static class Edge implements Serializable {
        ...
        public boolean equals(Object that) {
            ...
            return m_atomicRole.equals(thatEdge.m_atomicRole) && m_fromVertex == thatEdge.m_fromVertex
                    && m_toVertex == thatEdge.m_toVertex;
        }
    }
}
