...
public abstract class AbstractReasonerTest extends AbstractOntologyTest {
     ...
     *
     * @param subAtomicConcept   a string that represents an atomic concept. If no prefix is given, NS is used as prefix
     * @param superAtomicConcept a string that represents an atomic concept. If no prefix is given, NS is used as prefix
